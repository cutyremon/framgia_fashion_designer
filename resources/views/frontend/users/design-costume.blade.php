                            ...
                            <div class="box-clothes">
                                    ...
                                    <div class="box-jewelry">
                                        <div class="nd-wrap nd-style-8">
                                            <div class="product-item" data-category="4">
                                                <img src="{!! asset('images/jewelry.png') !!}" class="img_4"/>
                                                <div class="nd-content" data-toggle="modal" data-target="#select">
                                                    <div class="nd-content_inner">
                                                        <div class="nd-content_inner1">
                                                            <h6 class="nd-title">{{ __('jewelry') }}</h6>
                                                            <span class="nd-icon" id="select-jewelry" data-category="4">
                                                                <i class="fa fa-plus"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="box-shirt">
                                        <div class="nd-wrap nd-style-8">
                                            <div class="product-item" data-category="2">
                                                <img src="{!! asset('images/shirts_1.png') !!}" class="img_2"/>
                                                <div class="nd-content" data-toggle="modal" data-target="#select">
                                                    <div class="nd-content_inner">
                                                        <div class="nd-content_inner1">
                                                            <h6 class="nd-title">{{ __('shirt') }}</h6>
                                                            <span class="nd-icon" id="select-shirt" data-category="2">
                                                                <i class="fa fa-plus"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="box-accessories">
                                        <div class="nd-wrap nd-style-8">
                                            <div class="product-item" data-category="5">
                                                <img src="{!! asset('images/accessories.png') !!}" class="img_5"/>
                                                <div class="nd-content" data-toggle="modal" data-target="#select">
                                                    <div class="nd-content_inner">
                                                        <div class="nd-content_inner1">
                                                            <h6 class="nd-title">{{ __('accessories') }}</h6>
                                                            <span class="nd-icon" id="select-accessories" data-category="5">
                                                                <i class="fa fa-plus"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <div class="box-shoes">
                                    <div class="nd-wrap nd-style-8">
                                        <div class="product-item" data-category="3">
                                            <img src="{!! asset('images/shoes.png') !!}" class="img_3"/>
                                            <div class="nd-content" data-toggle="modal" data-target="#select">
                                                <div class="nd-content_inner">
                                                    <div class="nd-content_inner1">
                                                        <h6 class="nd-title">{{ __('shoes') }}</h6>
                                                        <span class="nd-icon" id="select-shoes" data-category="3">
                                                            <i class="fa fa-plus"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div class="box-pants">
                                    <div class="nd-wrap nd-style-8">
                                        <div class="product-item" data-category="1">
                                            <img src="{!! asset('images/pants.png') !!}" class="img_1"/>
                                            <div class="nd-content" data-toggle="modal" data-target="#select">
                                                <div class="nd-content_inner">
                                                    <div class="nd-content_inner1">
                                                        <h6 class="nd-title">{{ __('pants') }}</h6>
                                                        <span class="nd-icon" id="select-pants" data-category="1">
                                                            <i class="fa fa-plus"></i>
                                                        </span>
                                                    </div>
                                                </div>
                        ...
                        <div class="information-costume">
                            ...
                            <div class="well">
                                <ul class="nav nav-tabs">
                                    <li class="active tag_5"><a href="#accessories" data-toggle="tab">{{ __('accessories') }}</a></li>
                                    <li class="tag_4"><a href="#jewelry" data-toggle="tab">{{ __('jewelry') }}</a></li>
                                    <li class="tag_2"><a href="#shirt" data-toggle="tab">{{ __('shirt') }}</a></li>
                                    <li class="tag_3"><a href="#shoes" data-toggle="tab">{{ __('shoes') }}</a></li>
                                    <li class="tag_1"><a href="#pants" data-toggle="tab">{{ __('pants') }}</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content">
                                    <div class="tab-pane active in information_5" id="accessories"></div>
                                    <div class="tab-pane fade information_4" id="jewelry"></div>
                                    <div class="tab-pane fade information_2" id="shirt"></div>
                                    <div class="tab-pane fade information_3" id="shoes"></div>
                                    <div class="tab-pane fade information_1" id="pants"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog form-edit">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" data-dismiss="modal">{{ __('save') }}</button>
                    </div>
                </div>
            </div>
        </div>
