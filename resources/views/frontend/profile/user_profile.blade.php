			...
			<div class="profile-head">
										...
										<div class="row">
											<div class="wrap-image-upload">
												...
												<div class="col-md-6 col-lg-6 img-padding-circle image-upload" align="center">
													<img alt="User Pic" id= "image_target" class="img-circle img-responsive" width="300px" height="300px">
												</div>
											</div>
										</div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					...
					<ul>
						...
						<li><a href="javascript:void(0)" class="span-edit-profile text-warning" data-toggle="modal" data-target="#per-info">(Change Profile
											...
											<form>
												<div class="row">
													<div class="form-group col-md-6 col-xs-12">
														...
														<input class="form-control " type="text" placeholder="name" id="display_name">
													</div>
													<div class="form-group col-md-6 col-xs-12">
												...
												<div class="row">
													<div class="form-group col-md-6 col-xs-12">
														...
														<input class="form-control date_of_birth" type="date" id="date_of_birth">
													</div>
													<div class="form-group col-md-6 col-xs-12">
														<label for="phone">Điện Thoại</label>
														<input class="form-control phone" type="text" id="phone" placeholder="phone">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-6 col-xs-12">
													...
													<div class="form-group col-md-6 col-xs-12">
														...
														<input class="form-control" type="text" id="nationality" placeholder="Vietnamese">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-6 col-xs-12">
												...
												<div class="row">
													<div class="form-group col-md-12 col-xs-12">
														...
														<textarea class="form-control" type="text" row="6" id="description"></textarea>
													</div>
												</div>
											</form>
										</div>
							...
							<!--//end edit infpration -->
							<a href="javascript:void(0)" class="span-edit-profile text-warning" data-toggle="modal" data-target="#modalPassword">(Change Password
								<i class="fa fa-pencil" aria-hidden="true"></i>)
							</a>
										...
										<div class="modal-body ">
											<form>
												<div class="form-group">
													...
													<input class="form-control" type="password" id="old_password" placeholder=" old password">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input class="form-control" id="comfirm" type="password" placeholder="comfirm password">
												</div>
											</form>
										<div class="modal-footer">
											<button type="submit" class="btn btn-default" data-dismiss="modal">Submit</button>
